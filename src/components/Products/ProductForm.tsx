...
import { productCategorySchema, type Product, type ProductFormData, productFormDataSchema } from "../../types";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                    <div>
                        ...
                        <input type="text" {...register("productName")} className="input-style" />
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select {...register("category")} className="input-style appearance-none">
                    ...
                    <div className="flex gap-4">
                        <div className="flex-1">
                            ...
                            <input type="number" {...register("price", { valueAsNumber: true })} className="input-style" />
                            {errors.price && <ErrorMessage>{errors.price.message}</ErrorMessage>}
                        </div>
                        <div className="flex-1">
                            <label className="block text-sm font-medium text-gray-700 mb-2">Costo ($MX)</label>
                            <input type="number" {...register("cost", { valueAsNumber: true })} className="input-style" />
                    ...
                    <div>
                        ...
                        <textarea rows={4} {...register("description")} className="input-style resize-none" />
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex-1 border-2 border-dashed rounded-lg flex flex-col items-center justify-center p-6 text-center">
                        ...
                        <span className="text-gray-500 text-sm">Previsualización de la imagen</span>
